    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((card) => (
          <div
            key={card.title}
            className="bg-card p-6 rounded-xl border border-border flex items-start justify-between shadow-sm"
          >
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="bg-card rounded-xl border border-border shadow-sm">
            ...
            <div className="p-6">
              <div className="relative h-48 w-full bg-black/10 rounded-lg overflow-hidden flex items-center justify-center">
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-border">
                    {stats.department_stats.map((dept: { department_name: string; total_employees: number; present_today: number; attendance_rate: number }) => (
                      <tr key={dept.department_name} className="hover:bg-primary/5 transition-colors">
